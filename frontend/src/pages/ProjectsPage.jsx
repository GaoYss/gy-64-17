...
const editProjectFields = [
  { name: "id", label: "Project ID", type: "number", required: true, initial: "" },
  { name: "customer_name", label: "Customer", type: "text", initial: "" },
  { name: "project_name", label: "Project", type: "text", initial: "" },
      ...
      <div className="form-grid">
        ...
        <RecordForm
          ...
          onSubmit={(payload) => {
            ...
            return updateRecord("projects", Number(id), data);
          }}
        />
      </div>
